...
IPC_MESSAGE_ROUTED2(FrameHostMsg_GetFFparam, std::string, std::string)
...
//
//#ifndef FAKEFINGERPRINT_MESSAGES_H
//#define FAKEFINGERPRINT_MESSAGES_H
//
//namespace IPC {
//
...
//}  // namespace IPC
//
//#endif  // FAKEFINGERPRINT_MESSAGES_H
