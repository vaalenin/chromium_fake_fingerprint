...
# if OPTIONAL_HAS_MOVE_ACCESSORS == 1
  ...
  T const& operator *() const& {
    return TR2_OPTIONAL_ASSERTED_EXPRESSION(this->initialized(), contained_val());
  }
  ...
  constexpr T const& value() const& {
      return initialized() ? contained_val() : contained_val();// (throw bad_optional_access("bad optional access"), contained_val());
  }
...
public:
  ...
  constexpr T& value() const {
      return ref ? *ref : *ref;// (throw bad_optional_access("bad optional access"), *ref);
  }
